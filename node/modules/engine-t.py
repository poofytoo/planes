...
class Engine:
  ...
  def getBotOutputs(self):
    ...
    p1 = subprocess.Popen("sudo -u nobody " + bot1command, shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
    p2 = subprocess.Popen("sudo -u nobody " + bot2command, shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
...
if __name__ == "__main__":
  args = sys.argv
  if len(args) <= 3 or 'help' in args[2]:
